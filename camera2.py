...
#url = "rtsp://admin:135Maxim@10.2.11.5/Streaming/Channels/101"
## Вариант 1
...
#url = "rtsp://192.168.0.7:554/user=admin&password=123Lisuin&channel=0&stream=1.sdp?"
#url = "rtsp://192.168.0.71:554/user=admin&password=MKL28200205As&channel=0&stream=1.sdp?"
...
url2 = "rtsp://Admin:1234@192.168.0.8:554/snl/live/2/1"
...
while True:
    ...
    #dilate2 = cv2.dilate(img_sub2, np.ones((5,5)))
    kernel = cv2.getStructuringElement(cv2.MORPH_ELLIPSE,(5,5))
    dilatada = cv2.morphologyEx(dilate, cv2.MORPH_CLOSE, kernel)
    #dilatada2 = cv2.morphologyEx(dilate2, cv2.MORPH_CLOSE, kernel)
